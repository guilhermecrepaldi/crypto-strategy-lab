# M027 — independent source-bound preflight review
...
The reviewed snapshot implements the OWNER-authorized M027 controlled A/B with
no remaining blocking defect. Approval is conditional on canonical publication,
clean/published preflight, and exactly one CONTROL plus one TREATMENT on the fixed
three-hour tape. This is not approval of profitability, live execution or a
successor. `TEST_SUITE_PASS != STRATEGY_PASS`.

The first review blocked mixed trade/L2 tick evidence, late capital matching,
incomplete transitive source binding and unverified MICRO report counters. The
second blocked touch labels that were only checked for canonical membership. The
final source now proves fine prices specifically from native L2 updates, compares
both initial banks before any trade, binds all M026 dependencies, independently
reconstructs distance/MICRO metrics, and recreates the exact MICRO-only touch set
from causal hotline changes plus canonical side/price/time. Zero-control throughput
cannot pass the strong ruler. Pending and queue-free ENTRY time is not mislabeled
as price recovery.

Forty-nine focused tests passed, including adversarial false-metric, false-touch,
coarse-L2/fine-trade, FIFO, cancel-ACK, checkpoint, capital and denominator cases.
No historical replay, account, Testnet, live action, file edit or publication was
performed by the reviewer.

## Exact reviewed source closure — LF SHA256

REVIEWED_SOURCE_SHA256_LF[scripts/run_micro_hot_reallocation.py]=e5b27eda6827f29cb46ce72324951d38ab186d9aac08fda8f40014ed2f1a6b10
REVIEWED_SOURCE_SHA256_LF[scripts/audit_micro_hot_reallocation.py]=075a35c3cb39ccfca187cebac2e10a4d20ef43bb83abacb3f45bdc86fe7b8d2b
REVIEWED_SOURCE_SHA256_LF[scripts/register_micro_hot_reallocation.py]=d5acae1d8751d4548bd57d6167eaed4f9d23fa3bf2591cdae9c0bd297617cc13
REVIEWED_SOURCE_SHA256_LF[src/crypto_strategy_lab/microstructure/micro_hot_reallocation.py]=6be76874a0ca10d43602247d434da008cb11757bb42787bf8048f6f93d7a7454
REVIEWED_SOURCE_SHA256_LF[tests/test_micro_hot_reallocation.py]=fa7a906aa380027cd8125bbbc04eaf090c61e2fca5811cbb9e807af873820054
REVIEWED_SOURCE_SHA256_LF[tests/test_run_micro_hot_reallocation.py]=775e2d16a6a6ed750faceaf5b435ba0699ae4ff4d845a489d43d2a20c1cc78ff
