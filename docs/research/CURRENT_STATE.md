...
CAMPAIGN_STATUS=CONSECUTIVE_12D_COMPLETE_CONDITIONAL
CAMPAIGN_EXECUTION_SOURCE_SHA=9e176dd1d16969c37accbbba36fd763e67ffdde2
CAMPAIGN_ACTIVE_ENVELOPE=NONE
CAMPAIGN_QUEUED_ENVELOPE=NONE
CAMPAIGN_VERDICT=COMPLETE_CONDITIONAL_SYNTHETIC_STRESS; MINIMUM_500_NOT_MET
CAMPAIGN_PROGRESS_FILE=artifacts/usdcusdt/l2-monthly-samples/SYNTHETIC_CONSECUTIVE_12D/CONSERVATIVE_QUEUE/progress.json
...
CURRENT_ACTIVE_RESEARCH_MODEL=M015
...
MONTHLY_ECONOMIC_REPLAYS_STARTED=2
...
NEXT_CAMPAIGN_STATUS=AUTOPSY_AND_PREREGISTRATION; NOT_EXECUTED
NEXT_CAMPAIGN_HOLD_OBJECTIVE_HOURS=2
NEXT_CAMPAIGN_FUNDING=NOT_SELECTED
...
and returns are not continuous historical/live observations. No successor run yet.
