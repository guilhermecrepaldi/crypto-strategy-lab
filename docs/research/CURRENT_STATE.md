...
ACTIVE_EXECUTION_CAMPAIGN=M030_PREPARATION
CAMPAIGN_STATUS=M030_READY_FOR_PRERUN_PUBLICATION
CAMPAIGN_EXECUTION_SOURCE_SHA=PENDING_PUBLISHED_PRERUN_COMMIT
CAMPAIGN_ACTIVE_ENVELOPE=NONE_PRE_RUN
CAMPAIGN_QUEUED_ENVELOPE=M030_HOTLINE_FIRST_RANDOM_3H_FULL_DAY_ENGINE
...
CURRENT_ACTIVE_RESEARCH_MODEL=M030
...
OWNER_NEXT_RESEARCH=M030_HOTLINE_FIRST_REALLOCATION
OWNER_DIRECTIVE=docs/microstructure/M030_HOTLINE_FIRST_REALLOCATION_OWNER_DIRECTIVE.md
NEXT_CAMPAIGN_STATUS=AUTHORIZED_SOURCE_REVIEW_PASS_PUBLICATION_PENDING
...
M030 is the authorized material management successor to M026, using M029 only as
