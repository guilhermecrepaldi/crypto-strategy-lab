...
class RewardBreakdown:
    ...
    def as_dict(self) -> dict[str, str]:
        return {
            ...
            "rotation_penalty": str(self.rotation_penalty),
...
def calculate_reward(
    *,
    ...
    return RewardBreakdown(
        ...
        rotation_penalty=config.rotation_coefficient if rotated else Decimal("0"),
